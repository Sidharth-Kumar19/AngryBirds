...
public class Level2 implements Screen{
    ...
    public Level2(AngryBirds game, boolean isNewGame, LevelData d){
    ...
    public void saveLevel(){
        try (ObjectOutputStream o1 = new ObjectOutputStream(new FileOutputStream("DataStorage2.dat"))) {
            ...
            System.out.println("Data saved successfully to " + "DataStorage2.dat");
        }
        catch(IOException e){
